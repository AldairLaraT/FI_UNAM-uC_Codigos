...
void GPIO_PortJ_Init(void) {
    ...
    reg &= ~GPIO_PC_EDM0_M;                                                         /*  PortJ[0] => EDM: Extended Drive Mode -> Bits cleared */
    reg |= (0 << GPIO_PC_EDM0_S);                                                   /*  PortJ[0] => EDM: Extended Drive Mode -> Drive values of 2, 4 and 8mA are maintained */
    ...
    GPIO_PORTJ_AHB_ICR_R &= ~GPIO_PIN_0;                                            /*  PortJ[0] => IC: Interrupt Clear -> Interrupt unaffected */
    GPIO_PORTJ_AHB_IM_R &= ~GPIO_PIN_0;                                             /*  PortJ[0] => IME: Interrupt Mask Enable -> Interrupt masked */
