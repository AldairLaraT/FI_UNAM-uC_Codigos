...
#define TIMER2_TAPMR_R              (*((volatile uint32_t *)0x40032040))            /*  pp1010  GPTM Timer A Prescale Match */
...
#define GPTM2_A_Initiate()          (TIMER2_CTL_R |= TIMER_CTL_TAEN)                /*  GPTM0 => TAEN: GPTM Timer A Enable -> Enabled and begins counting */
...
void GPTM2A_Init_PWM(uint32_t PWM_frequency, uint32_t PWM_DutyCycle);               /*  Inicialización del GPTM2 (subtimer A) en modo PWM */
