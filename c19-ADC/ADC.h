...
#define ADC0_SS1_RawInterrupt_wait()    while (!(ADC0_RIS_R & ADC_RIS_INR1)) {}     /*  ADC0 => INR1: SS1 Raw Interrupt Status -> A sample has completed conversion */

    /*  Lectura del resultado de conversión */
#define ADC0_SS1_FIFOread()         (ADC0_SSFIFO1_R & ADC_SSFIFO1_DATA_M)           /*  ADC0 SS1 => DATA: Conversion Result Data */

    /*  Limpieza de las banderas INn (ADCISC) y INRn (ADCRIS) */
#define ADC0_SS1_ClearFlags()       (ADC0_ISC_R |= ADC_ISC_IN1)                     /*  ADC0 => IN1: SS1 Interrupt Status and Clear -> IN1 bit (ADCISC) and INR1 bit (ADCRIS) cleared */
